...
import demographicsIcon from "../../../../../assets/demographicsIcon.png";
import surveyIcon from "../../../../../assets/surveyIcon.png";
import questionpoolIcon from "../../../../../assets/questionpoolIcon.png";
import reportIcon from "../../../../../assets/reportIcon.png";

const menus = [
  {
    label: "sidebar.menu.mainMenu",
    type: "section",
    children: [
      {
        uri: "/mainMenu/dashboard",
        label: "Dashboard",
        type: "nav-item",
        icon: <img src={dashboardIcon} style={{ width: "19px" }} />,
      },
      {
        uri: "/mainMenu/management",
        label: "Client Management",
        type: "nav-item",
        icon: <img src={clientIcon} style={{ width: "19px" }} />,
      },
      {
        uri: "/mainMenu/categoryManagement",
        label: "Category Management",
        type: "nav-item",
        icon: <img src={categoryIcon} style={{ width: "19px" }} />,
      },
      {
        uri: "/mainMenu/demographics",
        label: "Demographics",
        type: "nav-item",
        icon: <img src={demographicsIcon} style={{ width: "19px" }} />,
      },
      {
        uri: "/mainMenu/surveys",
        label: "Surveys",
        type: "nav-item",
        icon: <img src={surveyIcon} style={{ width: "19px" }} />,
      },
      {
        uri: "/mainMenu/questionPools",
        label: "Question Pools",
        type: "nav-item",
        icon: <img src={questionpoolIcon} style={{ width: "19px" }} />,
      },
      {
        uri: "/mainMenu/reports",
        label: "Reports",
        type: "nav-item",
        icon: <img src={reportIcon} style={{ width: "19px" }} />,
      },
    ],
  },
